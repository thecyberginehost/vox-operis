-- ================================================================
-- Fix Analytics User Count Issue - Corrected Version
-- Drops and recreates function to fix return type issue
-- ================================================================
...
BEGIN
    ...
    result := jsonb_build_object(
        ...
        'analytics_total_users', COALESCE(latest_analytics_total, 0),
        'checked_at', NOW()
    );
...
-- Recreate calculate_daily_analytics function with JSONB return type
...
BEGIN
    ...
    -- Handle security_logs table if it exists
...
COMMENT ON FUNCTION public.calculate_daily_analytics IS 'Calculates daily analytics with proper user counting and returns debug info';
